              ...
              <div class="card mt-3">
                <ul class="list-group list-group-flush">
                  ...
                  <li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                   ...
                   <div class="row">
                     <div class="col-sm-12">
                     	<button id="editSocialAccountForm" class="btn btn-info " style="display:none" >Submit</button>
                        <button id="editSocialAccountButton" class="btn btn-info " value="Edit" onclick='editSocialAccount("<%=website%>", "<%=twitter%>", "<%=facebook%>", "<%=instagram%>")' >Edit</button>
                     </div>
                   </div>
                  </li>
                </ul>
