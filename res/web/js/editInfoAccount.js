...
function editSocialAccount(website, twitter, facebook, instagram) {
	...
	var editWebsite = function (website) {
		...
		var edit = "";
		edit = "<div class='col-sm-9 text-secondary'>";
		edit += "<input type='text' class='form-control' value='" + website + "'>";
		edit += "</div>";
	...
	var editTwitter = function (twitter) {
		...
		var edit = "";
		edit = "<div class='col-sm-9 text-secondary'>";
		edit += "<input type='text' class='form-control' value='" + twitter + "'>";
		edit += "</div>";
	...
	var editFacebook = function (facebook) {
		...
		var edit = "";
		edit = "<div class='col-sm-9 text-secondary'>";
		edit += "<input type='text' class='form-control' value='" + facebook + "'>";
		edit += "</div>";
	...
	var editInstagram = function (instagram) {
		...
		var edit = "";
		edit = "<div class='col-sm-9 text-secondary'>";
		edit += "<input type='text' class='form-control' value='" + instagram + "'>";
		edit += "</div>";
