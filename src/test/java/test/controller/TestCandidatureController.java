...
public class TestCandidatureController {
	...
	public void testAInsertCandidature() 
		...
		candidature.setOffer(OfferController.getOfferById(4));
	...
	public void testBGetCandidature() throws InternalException {
		assertNotEquals(null, CandidatureController.getCandidature(4, "SRRPQR04R45A422Y"));
	}
	
	@Test
	public void testCDeleteCandidature() throws InternalException {
		
		CandidatureBean candidature=CandidatureController.getCandidature(4, "SRRPQR04R45A422Y");
		
		CandidatureController.deleteCandidature(candidature.getJobSeeker(),candidature);
		assertEquals(null, CandidatureController.getCandidature(4, "SRRPQR04R45A422Y"));
	}
